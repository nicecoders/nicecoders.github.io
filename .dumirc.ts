...
export default defineConfig({
  ...
  resolve: {
    ...
    atomDirs: [
      ...
      { type: 'cli', dir: 'packages/cli/src' },
      { type: 'changelog', dir: 'packages/changelog/src' },
      { type: 'sensitiveWords', dir: 'packages/sensitiveWords/src' },
      { type: 'snippets', dir: 'packages/snippets/src' },
      { type: 'player', dir: 'packages/player/src' },
      { type: 'spider', dir: 'packages/spider/src' },
    ],
  },
  monorepoRedirect: {
    srcDir: ['packages', 'src'],
