...
// @ts-ignore
import { generateImg, get, addEventListenerWrapper } from '@nicecode/func';
import { useUpdateEffect } from '@nicecode/hooks';
...
const componentName = `nicecode-image__compater-view`;
